...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .dot { width: 12px; height: 12px; border-radius: 50%; background: #3a3a40; border: none; padding: 0; cursor: pointer;
         display: grid; place-items: center; color: transparent; font-size: 9px; line-height: 1; transition: background .18s; }
  .dots:hover .d-close { background: #ff5f56; } .dots:hover .d-min { background: #ffbd2e; } .dots:hover .d-max { background: #27c93f; }
